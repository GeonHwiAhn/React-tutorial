...
Hook 종류 = react에서 어떤 동작이나 상태를 표현하거나 변경할 때 사용하는 기능들
 ...
 import React, {useState} from 'react';
 두개 이상의 훅을 작성
 impor React, {useState, useEffect, useContext, ..넣고싶은 기능 작성} from 'react';
...
모두 표현하는 방식이 다르지만 의미하는 바는 똑같음  
*/
 const State예제1    = () => { 

// test = 가장 처음에 가지고 있는 변수값, 처음에 값이 없으면 값이 없는 상태로 있는것
