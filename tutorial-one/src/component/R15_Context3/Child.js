    ...
    return (
        <div>
            ...
            {/* onChange={(e) => {setInputName(e.target.value)}}
                ...
                e(움직임이 발생).target(움직임이 발생한 목표).value(값이 무엇인이 가져옴)

                value={inputNmae}
                 값={초기값(=useState('') ) }
                 
                 움직임이 발생하면 value에 작성된 초기값은 감지된 값으로 변경됨
                */}
