...
const Axios_JSON = () => {
    return (
        ...
        <pre>
            ...
            https://jsonplaceholder.typicode.com/ 을 많이 사용
            <a href="https://jsonplaceholder.typicode.com/">jsonplaceholder 이동하기</a>
            jsonplaceholder : 임시데이터로 사진이나, 포스터 내용과 같은 파일을 만들고 개발자들에게 무료로 배포
        ...
        <h3>비동기처리</h3>
        Ajax    : 자바스크립트를 이용해서 서버와 비동기적으로 데이터를 교화 FetchAPI를 사용   
